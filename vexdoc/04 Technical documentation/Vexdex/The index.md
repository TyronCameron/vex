...
- **`focus.bin`** / **`focus.lua`** — the same binary+mirror pattern, but for your currently-saved [[CLI reference#Focuses|focus]] rather than the task index.
